...
<template>
  <div class="pricing-plan w-[364px] px-[24px] pt-[60px] pb-[20px] border border-devider rounded-md text-center relative">
    ...
    <div class="pricing-plan__price flex justify-center mt-[20px]">
      <div class="text-text-secondary text-15-500 self-start">{{ wallet }}</div>
      <h1 class="text-primary-500">{{ price }}</h1>
    ...
    <ul class="pricing-plan__possibilities flex flex-col mt-[20px] gap-[16px]">
